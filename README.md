...
* More robust error reporting.  PDO Wrapper makes use of enums for representing error codes, ensuring that the error code is always valid for the database you're connected to.
