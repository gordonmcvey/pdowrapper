 ...
 *
 * This extended factory maintains a cache of previously prepared PDOStatements.  If a request ia made for a PDOStatement
 * that already exists in the cache, then the cached version is returned.  This reduces both the number of statements
 * prepared, which in turn should lead to some performance improvement.
 *
...
{
    /*
     * This hashing algorithm has been selected for speed, as we want this method to add as little overhead as practical.
     * As this algorithm is optimised for speed rather than low probability of collisions we may need to look into
     * additional measures to avoid two completely different SQL strings colliding and the wrong statement being returned,
     * such as bucketing.
     *
